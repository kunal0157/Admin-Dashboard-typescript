    ...
    <div className="admin-container">
        ...
        <main className="dashboard">
          ...
          <section className="widget-container">
            ...
            <WidgetItem percent={40}  value={340000} heading="Revenue" color="rgb(0,115,255)"/>
            <WidgetItem percent={-40} value={4000} heading="Users" color="rgb(0,198,202)"/>
